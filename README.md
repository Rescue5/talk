...
- независимые слои грубого контура и уточнённого талька с настройкой opacity;
- каждый снимок хранит собственные пороги сегментации, CV, доли талька и
  ordinary/difficult;
- статистика площадей, confidence карт сегментации/CV и времени этапов;
...
- два совместимых checkpoint-файла: для талька и классификатора сульфидов.
